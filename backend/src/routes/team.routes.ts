...
import { createTeamSchema, updateTeamSchema, addTeamMemberSchema, updateTeamMemberSchema } from '../dtos/index.js';
...
router.put('/:id/members/:userId', validateBody(updateTeamMemberSchema), teamController.updateMemberRole as any);
...
router.get('/:id/dashboard/unassigned', requireTeamLeader() as any, teamDashboardController.getUnassignedTasks as any);
router.post('/:id/dashboard/assign', requireTeamLeader() as any, teamDashboardController.assignTask as any);
