 ...
 * @access  Admin only
 */
router.get('/users', validateQuery(adminUserQuerySchema), adminController.listUsers as any);
 ...
 * @access  Admin only
 */
router.post('/users', validateBody(adminCreateUserSchema), adminController.createUser as any);
 ...
 * @access  Admin only
 */
router.put('/users/:id', validateBody(adminUpdateUserSchema), adminController.updateUser as any);
 ...
 * @access  Admin only
 */
router.post('/users/:id/activate', adminController.activateUser as any);
 ...
 * @access  Admin only
 */
router.post('/tasks/bulk', adminController.bulkTaskOperation as any);
 ...
 * @access  Admin only
 */
router.post('/tasks/bulk/preview', adminController.bulkTaskPreview as any);
 ...
 * @access  Admin only
 */
router.get('/audit-logs/:entityType/:entityId', adminController.getEntityAuditHistory as any);
